...
import com.artalk.ripeer.constants.conversationTestTag
import com.artalk.ripeer.models.MessageModel
import com.artalk.ripeer.ui.conversations.components.MessageCard
import com.artalk.ripeer.ui.conversations.components.TextInput
import com.artalk.ripeer.ui.conversations.ui.theme.ArtalkTheme
import com.artalk.ripeer.ui.theme.BackGroundColor

@Composable
fun Conversation(apiKey: String, voiceId: String) {
    ArtalkTheme {
        Surface(
...
fun DefaultPreview2() {
    ArtalkTheme {
        Conversation(apiKey = "test", voiceId = "test")
    }
}
